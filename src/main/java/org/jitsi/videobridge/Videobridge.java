...
public class Videobridge
{
    ...
    */
     ...
     */
    private static final net.java.sip.communicator.util.Logger logger = net.java.sip.communicator.util.Logger.getLogger(Videobridge.class);
    ...
    public Conference createConference(String focus)
    {
         ...
         */
           ...
           /* logger.info("Created conference " + conference.getID()
